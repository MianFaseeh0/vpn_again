...
class Connectedstate2 extends ConsumerStatefulWidget {
  const Connectedstate2({required this.button, required this.text, super.key});
  final Widget button;
  final String text;
  @override
  ConsumerState<Connectedstate2> createState() {
    return _ConnectedstateState();
  }
}

class _ConnectedstateState extends ConsumerState<Connectedstate2> {
  ...
  Widget build(BuildContext context) {
    final lastSaved = ref.read(stopwatchProvider.notifier).lastSavedTime;
